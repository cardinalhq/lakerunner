...
type QueueLogRecompactRequest struct {
	...
	SortVersionBelowCurrent bool                   `protobuf:"varint,5,opt,name=sort_version_below_current,json=sortVersionBelowCurrent,proto3" json:"sort_version_below_current,omitempty"` // Filter: segments where sort_version < current
...
func (x *QueueLogRecompactRequest) GetSortVersionBelowCurrent() bool {
	if x != nil {
		return x.SortVersionBelowCurrent
	}
	return false
}
...
const file_admin_proto_rawDesc = "" +
	...
	"\vend_dateint\x18\x03 \x01(\x05R\n" +
	"endDateint\x12,\n" +
	"\x12missing_agg_fields\x18\x04 \x01(\bR\x10missingAggFields\x12;\n" +
	"\x1asort_version_below_current\x18\x05 \x01(\bR\x17sortVersionBelowCurrent\x12\x17\n" +
	"\adry_run\x18\x06 \x01(\bR\x06dryRun\"|\n" +
	"\x19QueueLogRecompactResponse\x12'\n" +
	"\x0fsegments_queued\x18\x01 \x01(\x05R\x0esegmentsQueued\x126\n" +
	"\bsegments\x18\x02 \x03(\v2\x1a.adminproto.LogSegmentInfoR\bsegments\"\xd8\x01\n" +
	"\x0eLogSegmentInfo\x12\x1d\n" +
	"\n" +
	"segment_id\x18\x01 \x01(\x03R\tsegmentId\x12\x18\n" +
	"\adateint\x18\x02 \x01(\x05R\adateint\x12!\n" +
	"\finstance_num\x18\x03 \x01(\x05R\vinstanceNum\x12!\n" +
	"\frecord_count\x18\x04 \x01(\x03R\vrecordCount\x12!\n" +
	"\fsort_version\x18\x05 \x01(\x05R\vsortVersion\x12$\n" +
	"\x0ehas_agg_fields\x18\x06 \x01(\bR\fhasAggFields2\xb4\x13\n" +
	"\fAdminService\x129\n" +
	...
	"\x15DeleteLogStreamConfig\x12(.adminproto.DeleteLogStreamConfigRequest\x1a).adminproto.DeleteLogStreamConfigResponse\x12c\n" +
	"\x12GetWorkQueueStatus\x12%.adminproto.GetWorkQueueStatusRequest\x1a&.adminproto.GetWorkQueueStatusResponse\x12`\n" +
	"\x11QueueLogRecompact\x12$.adminproto.QueueLogRecompactRequest\x1a%.adminproto.QueueLogRecompactResponseB-Z+github.com/cardinalhq/lakerunner/adminprotob\x06proto3"
...
var file_admin_proto_goTypes = []any{
	...
	(*GetWorkQueueStatusRequest)(nil),         // 50: adminproto.GetWorkQueueStatusRequest
	(*GetWorkQueueStatusResponse)(nil),        // 51: adminproto.GetWorkQueueStatusResponse
	(*WorkQueueTaskStatus)(nil),               // 52: adminproto.WorkQueueTaskStatus
	(*QueueLogRecompactRequest)(nil),          // 53: adminproto.QueueLogRecompactRequest
	(*QueueLogRecompactResponse)(nil),         // 54: adminproto.QueueLogRecompactResponse
	(*LogSegmentInfo)(nil),                    // 55: adminproto.LogSegmentInfo
...
var file_admin_proto_depIdxs = []int32{
	...
	56, // 3: adminproto.UpdateOrganizationRequest.name:type_name -> google.protobuf.StringValue
	57, // 4: adminproto.UpdateOrganizationRequest.enabled:type_name -> google.protobuf.BoolValue
	...
	52, // 17: adminproto.GetWorkQueueStatusResponse.tasks:type_name -> adminproto.WorkQueueTaskStatus
	55, // 18: adminproto.QueueLogRecompactResponse.segments:type_name -> adminproto.LogSegmentInfo
	0,  // 19: adminproto.AdminService.Ping:input_type -> adminproto.PingRequest
	2,  // 20: adminproto.AdminService.InQueueStatus:input_type -> adminproto.InQueueStatusRequest
	6,  // 21: adminproto.AdminService.ListOrganizations:input_type -> adminproto.ListOrganizationsRequest
	8,  // 22: adminproto.AdminService.CreateOrganization:input_type -> adminproto.CreateOrganizationRequest
	10, // 23: adminproto.AdminService.UpdateOrganization:input_type -> adminproto.UpdateOrganizationRequest
	12, // 24: adminproto.AdminService.GetConsumerLag:input_type -> adminproto.GetConsumerLagRequest
	16, // 25: adminproto.AdminService.ListOrganizationAPIKeys:input_type -> adminproto.ListOrganizationAPIKeysRequest
	18, // 26: adminproto.AdminService.CreateOrganizationAPIKey:input_type -> adminproto.CreateOrganizationAPIKeyRequest
	20, // 27: adminproto.AdminService.DeleteOrganizationAPIKey:input_type -> adminproto.DeleteOrganizationAPIKeyRequest
	23, // 28: adminproto.AdminService.ListOrganizationBuckets:input_type -> adminproto.ListOrganizationBucketsRequest
	25, // 29: adminproto.AdminService.AddOrganizationBucket:input_type -> adminproto.AddOrganizationBucketRequest
	27, // 30: adminproto.AdminService.DeleteOrganizationBucket:input_type -> adminproto.DeleteOrganizationBucketRequest
	30, // 31: adminproto.AdminService.ListBucketConfigurations:input_type -> adminproto.ListBucketConfigurationsRequest
	32, // 32: adminproto.AdminService.CreateBucketConfiguration:input_type -> adminproto.CreateBucketConfigurationRequest
	34, // 33: adminproto.AdminService.DeleteBucketConfiguration:input_type -> adminproto.DeleteBucketConfigurationRequest
	37, // 34: adminproto.AdminService.ListBucketPrefixMappings:input_type -> adminproto.ListBucketPrefixMappingsRequest
	39, // 35: adminproto.AdminService.CreateBucketPrefixMapping:input_type -> adminproto.CreateBucketPrefixMappingRequest
	41, // 36: adminproto.AdminService.DeleteBucketPrefixMapping:input_type -> adminproto.DeleteBucketPrefixMappingRequest
	44, // 37: adminproto.AdminService.GetLogStreamConfig:input_type -> adminproto.GetLogStreamConfigRequest
	46, // 38: adminproto.AdminService.SetLogStreamConfig:input_type -> adminproto.SetLogStreamConfigRequest
	48, // 39: adminproto.AdminService.DeleteLogStreamConfig:input_type -> adminproto.DeleteLogStreamConfigRequest
	50, // 40: adminproto.AdminService.GetWorkQueueStatus:input_type -> adminproto.GetWorkQueueStatusRequest
	53, // 41: adminproto.AdminService.QueueLogRecompact:input_type -> adminproto.QueueLogRecompactRequest
	1,  // 42: adminproto.AdminService.Ping:output_type -> adminproto.PingResponse
	3,  // 43: adminproto.AdminService.InQueueStatus:output_type -> adminproto.InQueueStatusResponse
	7,  // 44: adminproto.AdminService.ListOrganizations:output_type -> adminproto.ListOrganizationsResponse
	9,  // 45: adminproto.AdminService.CreateOrganization:output_type -> adminproto.CreateOrganizationResponse
	11, // 46: adminproto.AdminService.UpdateOrganization:output_type -> adminproto.UpdateOrganizationResponse
	13, // 47: adminproto.AdminService.GetConsumerLag:output_type -> adminproto.GetConsumerLagResponse
	17, // 48: adminproto.AdminService.ListOrganizationAPIKeys:output_type -> adminproto.ListOrganizationAPIKeysResponse
	19, // 49: adminproto.AdminService.CreateOrganizationAPIKey:output_type -> adminproto.CreateOrganizationAPIKeyResponse
	21, // 50: adminproto.AdminService.DeleteOrganizationAPIKey:output_type -> adminproto.DeleteOrganizationAPIKeyResponse
	24, // 51: adminproto.AdminService.ListOrganizationBuckets:output_type -> adminproto.ListOrganizationBucketsResponse
	26, // 52: adminproto.AdminService.AddOrganizationBucket:output_type -> adminproto.AddOrganizationBucketResponse
	28, // 53: adminproto.AdminService.DeleteOrganizationBucket:output_type -> adminproto.DeleteOrganizationBucketResponse
	31, // 54: adminproto.AdminService.ListBucketConfigurations:output_type -> adminproto.ListBucketConfigurationsResponse
	33, // 55: adminproto.AdminService.CreateBucketConfiguration:output_type -> adminproto.CreateBucketConfigurationResponse
	35, // 56: adminproto.AdminService.DeleteBucketConfiguration:output_type -> adminproto.DeleteBucketConfigurationResponse
	38, // 57: adminproto.AdminService.ListBucketPrefixMappings:output_type -> adminproto.ListBucketPrefixMappingsResponse
	40, // 58: adminproto.AdminService.CreateBucketPrefixMapping:output_type -> adminproto.CreateBucketPrefixMappingResponse
	42, // 59: adminproto.AdminService.DeleteBucketPrefixMapping:output_type -> adminproto.DeleteBucketPrefixMappingResponse
	45, // 60: adminproto.AdminService.GetLogStreamConfig:output_type -> adminproto.GetLogStreamConfigResponse
	47, // 61: adminproto.AdminService.SetLogStreamConfig:output_type -> adminproto.SetLogStreamConfigResponse
	49, // 62: adminproto.AdminService.DeleteLogStreamConfig:output_type -> adminproto.DeleteLogStreamConfigResponse
	51, // 63: adminproto.AdminService.GetWorkQueueStatus:output_type -> adminproto.GetWorkQueueStatusResponse
	54, // 64: adminproto.AdminService.QueueLogRecompact:output_type -> adminproto.QueueLogRecompactResponse
