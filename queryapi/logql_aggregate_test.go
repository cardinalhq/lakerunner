...
func TestRewrite_CountOverTime_ByLevel_JSON(t *testing.T) {
	...
	mustExec(t, db, `
	INSERT INTO logs("_cardinalhq_timestamp", job, "_cardinalhq_message") VALUES
...
func TestRewrite_SumByPod_Rate_ServiceFilter(t *testing.T) {
	...
	mustExec(t, db, `
	INSERT INTO logs("_cardinalhq_timestamp","_cardinalhq_message","resource_service_name","resource_k8s_pod_name","log_source") VALUES
	-- Pod A, bucket 0 (3)
...
func TestRewrite_SumBy_LabelFormat_Service(t *testing.T) {
	...
	mustExec(t, db, `
	INSERT INTO logs("_cardinalhq_timestamp","_cardinalhq_message","resource_service_name") VALUES
	(10*1000,  'm', 'svc-a'),
	(20*1000,  'm', 'svc-a'),
	(40*1000,  'm', 'svc-b'),
...
func TestRewrite_CountOverTime_ByBasePod_WithJSONFilter(t *testing.T) {
	...
	mustExec(t, db, `
	INSERT INTO logs("_cardinalhq_timestamp","_cardinalhq_message","resource_service_name","resource_k8s_pod_name") VALUES
...
func TestRewrite_FilterThenJSON_UnwrapNested_Max(t *testing.T) {
	...
	// Two 1m buckets: [0..60s), [60..120s)
	mustExec(t, db, `
	INSERT INTO logs("_cardinalhq_timestamp","_cardinalhq_id","_cardinalhq_level","_cardinalhq_fingerprint",job,"_cardinalhq_message") VALUES
...
func TestToWorkerSQL_LineFormat_IndexThenJSON_TwoStage(t *testing.T) {
	...
	// - "_cardinalhq_timestamp"      (required)
	// - "_cardinalhq_message"        (replaced by line_format)
	...
	mustExec(t, db, `
	INSERT INTO logs("_cardinalhq_timestamp","_cardinalhq_message","resource_service_name","log_@OrderResult") VALUES
	...
	if !strings.Contains(sql, `_cardinalhq_message`) || !strings.Contains(sql, "json_extract_string") {
	...
	gotMsg := s(rows[0][`_cardinalhq_message`])
...
func TestRewrite_SumOverTime_Unwrap_BaseField_LineFilter(t *testing.T) {
	...
	mustExec(t, db, `
	INSERT INTO logs("_cardinalhq_timestamp","_cardinalhq_message","resource_service_name","log_quantity") VALUES
	...
	if !strings.Contains(sql, `"_cardinalhq_message" LIKE '%AddItem%'`) {
