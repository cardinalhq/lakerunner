...
func init() {
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			...
			slog.Info("Starting log compaction worker (processing from PostgreSQL work queue)")

			consumer, err := metricsprocessing.NewLogCompactionConsumer(ctx, cfg, mdb, sp, cmgr)
			if err != nil {
