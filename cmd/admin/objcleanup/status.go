...
func SetAPIKey(key string) {
	// objcleanup currently only supports local mode
}

func runObjCleanupStatus() error {
	if useLocal {
		return runLocalObjCleanupStatus()
	}
	return fmt.Errorf("remote objcleanup status not yet implemented - use --local flag")
}

func runLocalObjCleanupStatus() error {
	...
	printObjCleanupTable(cleanup)
	return nil
}

func printObjCleanupTable(cleanup []lrdb.ObjectCleanupBucketSummaryRow) {
