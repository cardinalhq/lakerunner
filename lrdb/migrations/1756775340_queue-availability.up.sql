...
-- NOTE: This migration previously modified metric_compaction_queue and metric_rollup_queue
-- tables which have since been dropped. These operations are now commented out.
