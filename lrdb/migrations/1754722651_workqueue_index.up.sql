...
CREATE INDEX IF NOT EXISTS idx_wq_expirable ON public.work_queue (heartbeated_at) INCLUDE (id) WHERE claimed_by <> -1;

-- This makes sure we can delete signal locks fast.
CREATE INDEX IF NOT EXISTS idx_signal_locks_work_id ON public.signal_locks(work_id);
...
CREATE INDEX IF NOT EXISTS idx_wq_gc_runnable_at
