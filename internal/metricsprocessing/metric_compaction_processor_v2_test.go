...
func TestMetricCompactionProcessorV2_New(t *testing.T) {
	store := &MockMetricCompactionStore{}
	processor := NewMetricCompactionProcessorV2(store, nil, nil, &config.Config{})
...
func TestMetricCompactionProcessorV2_GetTargetRecordCount(t *testing.T) {
...
func TestMetricCompactionProcessorV2_markSegmentsAsCompacted_EmptySegments(t *testing.T) {
	mockStore := &MockMetricCompactionStore{}
	processor := NewMetricCompactionProcessorV2(mockStore, nil, nil, &config.Config{})
...
func TestMetricCompactionProcessorV2_markSegmentsAsCompacted_WithSegments(t *testing.T) {
	mockStore := &MockMetricCompactionStore{}
	processor := NewMetricCompactionProcessorV2(mockStore, nil, nil, &config.Config{})
...
func TestMetricCompactionProcessorV2_getHourFromTimestamp(t *testing.T) {
	processor := NewMetricCompactionProcessorV2(nil, nil, nil, &config.Config{})
...
func TestMetricCompactionProcessorV2_performCompaction_ParameterConstruction(t *testing.T) {
	...
	assert.IsType(t, &MetricCompactionProcessorV2{}, processor)
