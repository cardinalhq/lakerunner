...
// TraceCompactionKey represents the key for grouping trace messages for compaction
type TraceCompactionKey struct {
...
func (k TraceCompactionKey) GetOrgID() uuid.UUID {
	return k.OrganizationID
}

// GetInstanceNum returns the instance number from the key
func (k TraceCompactionKey) GetInstanceNum() int16 {
	return k.InstanceNum
}

// TraceCompactionMessage represents a trace segment processing notification for compaction
// This implements GroupableMessage interface
type TraceCompactionMessage struct {
...
func (m *TraceCompactionMessage) GroupingKey() any {
	return TraceCompactionKey{
...
func (m *TraceCompactionMessage) RecordCount() int64 {
	return m.Records
}

// Marshal converts the message to JSON bytes
func (m *TraceCompactionMessage) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal converts JSON bytes to TraceCompactionMessage
