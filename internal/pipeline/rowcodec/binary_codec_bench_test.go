...
func BenchmarkBinary_RoundTrip(b *testing.B) {
	codec, err := NewBinary()
	if err != nil {
		b.Fatal(err)
	}
...
func BenchmarkBinary_Stream_Encode(b *testing.B) {
	codec, err := NewBinary()
	if err != nil {
		b.Fatal(err)
	}
...
func BenchmarkBinary_Stream_Decode(b *testing.B) {
	codec, err := NewBinary()
	if err != nil {
		b.Fatal(err)
	}
...
func BenchmarkBinary_Small(b *testing.B) {
	codec, err := NewBinary()
	if err != nil {
		b.Fatal(err)
	}
...
func BenchmarkBinary_Large(b *testing.B) {
	codec, err := NewBinary()
	if err != nil {
		b.Fatal(err)
	}
...
func BenchmarkBinary_FileSize(b *testing.B) {
	codec, err := NewBinary()
	if err != nil {
		b.Fatal(err)
	}
